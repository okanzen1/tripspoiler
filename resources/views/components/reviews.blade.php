    ...
    <section class="relative overflow-hidden bg-[#FFFAF9] py-20 md:py-28">
        ...
        <div class="relative max-w-7xl mx-auto px-4">
            ...
            {{-- <div class="mt-16 flex flex-col md:flex-row gap-4 justify-center">
                ...
                <a href="#review-form"
                    class="inline-flex items-center gap-2 rounded-full border border-[#c62e2e] px-6 py-3 text-sm font-semibold text-[#c62e2e] hover:bg-[#c62e2e] hover:text-white transition">
