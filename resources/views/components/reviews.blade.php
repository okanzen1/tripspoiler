                ...
                <div class="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div class="relative h-[420px] hidden md:block order-1 lg:order-2">
                        ...
                        <div
                            ...
                            <img src="{{ asset('/images/no-empty-three.webp') }}" alt="Travel planning"
                        ...
                        <div
                            ...
                            <img src="{{ asset('/images/no-empty-two.webp') }}" alt="City traveler"
                        ...
                        <div
                            ...
                            <img src="{{ asset('/images/no-empty-one.webp') }}" alt="Travel memories"
