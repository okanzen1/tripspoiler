    ...
    <section class="relative overflow-hidden bg-[#FFFAF9] py-20 md:py-28">
        ...
        <div class="relative max-w-7xl mx-auto px-4">
            ...
            <div class="mt-16 flex flex-col md:flex-row gap-4 justify-center">
                ...
                <form action="{{ route('reviews.go') }}" method="POST">
                    @csrf
                    <input type="hidden" name="source" value="{{ $source }}">
                    <input type="hidden" name="source_id" value="{{ $sourceId }}">

                    <button
                        class="inline-flex items-center gap-2 rounded-full bg-[#c62e2e] px-6 py-3 text-sm font-semibold text-white shadow-lg hover:bg-[#b92626] transition cursor-pointer">
